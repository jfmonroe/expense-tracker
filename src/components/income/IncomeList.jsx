...
import { INCOME_CATEGORIES, getCategoryIcon } from "../../utils/categories";
import styles from "./IncomeList.module.css";

/**
 * IncomeList shows all income entries in a searchable table.
 *
 * Same pattern as ExpenseList but filters to type === "income",
 * displays amounts in green with a "+" prefix.
